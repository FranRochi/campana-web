...
function forceColor(name: string): string {
  ...
  if (n.includes("CELESTE") || n.includes("FUERZA PATRIA") || n.includes("UNION POR LA PATRIA") || n.includes("FRENTE")) return "#5BB8FF";
  if (n.includes("VIOLETA") || n.includes("LIBERTAD AVANZA")) return "#8B5CF6";
  if (n.includes("AMARILLO") || n.includes("JUNTOS") || n.includes("CAMBIEMOS") || n.includes("PRO")) return "#F2C94C";
  if (n.includes("ROSA")) return "#F28BB3";
  const palette = ["#F28BB3", "#34C759", "#FF9500", "#5AC8FA"];
  let hash = 0;
...
function resolveColor(value: string | null | undefined): string {
  ...
  if (n === "CELESTE") return "#5BB8FF";
  if (n === "VIOLETA") return "#8B5CF6";
  if (n === "AMARILLO") return "#F2C94C";
  if (n === "ROSA") return "#F28BB3";
  return "";
}
...
const BLOQUE_OPTIONS = [
  ...
  { value: "fp", label: "PJ / Fuerza Patria", color: "#5BB8FF" },
  { value: "jxc", label: "PRO / Cambiemos / JxC", color: "#F2C94C" },
  { value: "lla", label: "Libertad Avanza", color: "#8B5CF6" },
  { value: "otro", label: "Otros / Locales", color: "#F28BB3" },
...
const FORTALEZA_PROVINCIAL_OPTIONS = [
  { value: "all", label: "Sin capa", color: undefined },
  { value: "mostrar", label: "Mostrar todos", color: undefined },
  { value: "fuerte", label: "Presencia fuerte", color: FORTALEZA_PROVINCIAL_COLORS.fuerte },
  { value: "competitivo", label: "Presencia competitiva", color: FORTALEZA_PROVINCIAL_COLORS.competitivo },
  { value: "debil", label: "Presencia débil", color: FORTALEZA_PROVINCIAL_COLORS.debil },
  { value: "muy_debil", label: "Presencia muy débil", color: FORTALEZA_PROVINCIAL_COLORS.muy_debil },
];
    ...
    <div className={styles.page}>
      <div className={styles.mapWrap}>
        ...
        <div className={styles.filtersBar} ref={filterBarRef}>
          ...
          <div className={styles.filterWrap}>
            ...
            {openDropdown === "fortaleza" && (
              <div className={styles.dropdown}>
                <div className={styles.dropdownHeader}>Fortaleza política</div>
          ...
          <div className={styles.filterWrap}>
            ...
            {openDropdown === "fortalezaProvincial" && (
              <div className={styles.dropdown}>
                <div className={styles.dropdownHeader}>FP/UxP · Elecciones Provinciales</div>
        ...
        <div className={styles.legend}>
          ...
          <div className={styles.legendItem}><span className={styles.legendDot} style={{ background: "#6BAED6" }} />PJ / Fuerza Patria</div>
          <div className={styles.legendItem}><span className={styles.legendDot} style={{ background: "#E8749A" }} />PRO / Cambiemos / LLA</div>
          <div className={styles.legendItem}><span className={styles.legendDot} style={{ background: "#B07ED4" }} />Otros / Locales</div>
          ...
          {activeFilters.fortaleza !== "all" && (
            <>
              ...
              <div className={styles.legendTitle}>Fortaleza política</div>
          ...
          {activeFilters.fortalezaProvincial !== "all" && (
            <>
              <div className={styles.legendDivider} />
              <div className={styles.legendTitle}>FP/UxP Provincial</div>
              <div className={styles.legendItem}><span className={styles.legendCircle} style={{ background: FORTALEZA_PROVINCIAL_COLORS.fuerte }} />Presencia fuerte</div>
              <div className={styles.legendItem}><span className={styles.legendCircle} style={{ background: FORTALEZA_PROVINCIAL_COLORS.competitivo }} />Presencia competitiva</div>
              <div className={styles.legendItem}><span className={styles.legendCircle} style={{ background: FORTALEZA_PROVINCIAL_COLORS.debil }} />Presencia débil</div>
              <div className={styles.legendItem}><span className={styles.legendCircle} style={{ background: FORTALEZA_PROVINCIAL_COLORS.muy_debil }} />Presencia muy débil</div>
            </>
          )}
        </div>
      </div>
            ...
            <>
              ...
              <div className={styles.infoSection}>
                ...
                <div className={styles.intendenteHeader}>
                  <div className={styles.infoValue}>{municipio.intendente || "--"}</div>
              ...
              {/* ── FORTALEZA: CONFIG (ponderaciones + texto) ── */}
              {false && fortalezaConfig && (
                <div className={styles.infoSection}>
                  <div className={styles.infoLabel}>Cómo se calcula</div>
                  {fortalezaConfig?.ponderaciones.map((p) => (
                    <div key={p.variable} className={styles.ponderacionRow}>
                      <span className={`${styles.ponderacionVar} ${!p.disponible ? styles.ponderacionPendiente : ""}`}>
                        {p.variable}
                      </span>
                      <span className={`${styles.ponderacionPeso} ${!p.disponible ? styles.ponderacionPendiente : ""}`}>
                        {p.disponible ? `${p.peso}%` : `${p.peso}% · pendiente`}
                      </span>
                    </div>
                  ))}
                  <p className={styles.fortalezaTexto}>{fortalezaConfig?.texto}</p>
                </div>
              )}

              {activeFilters.fortaleza !== "all" && fortalezaNivel && (
                <div className={styles.infoSection}>
                  <div className={styles.infoLabel}>Fortaleza política</div>
                  ...
                  <div className={styles.fortalezaDesglose}>
                    ...
                    {municipio.tendencia_2023_2025 != null && (
                      <div className={styles.fortalezaRow}>
                        ...
                        <strong>{formatDelta(municipio.tendencia_2023_2025)}</strong>
                      </div>
                    )}
              ...
              {activeFilters.fortalezaProvincial !== "all" ? (
                <>
                  ...
                  {fortalezaProvincialNivel && (
                    <div className={styles.infoSection}>
                      <div className={styles.infoLabel}>Fortaleza Provincial · FP/UxP</div>
